          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/mlvuong28/Simon-Game"
                  target="_blank"
                ...
                <button
                  onClick={() => window.open("https://mlvuong28.github.io/Simon-Game/", "_blank")}
            ...
            >
              ...
              <div className="h-6" />
              <div className="flex flex-wrap gap-2 mb-4">
                {["HTML", "CSS", "Boostrap"].map((tech, key) => (
                  <span
                    key={key}
                    className="
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/mlvuong28/TinDog"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-400 hover:text-blue-300 transition-colors"
                >
                ...
                <button
                  onClick={() => window.open("https://mlvuong28.github.io/TinDog/", "_blank")}
                  className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded transition-colors"
                >
                  Demo
                 </button>
